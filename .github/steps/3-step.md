...
1. Enter the following comment and click the **Submit review** button.
   ...
   <img width="300" alt="Submit review button" src="https://github.com/kryapp/skills-review-pull-requests-081726/blob/main/.github/images/submit-review-button.png?raw=true" />
